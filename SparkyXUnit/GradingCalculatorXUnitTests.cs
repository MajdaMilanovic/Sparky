...
namespace SparkyXUnitTest
{
    ...
    public class GradingCalculatorXUnitTests
    {
        ...
        [Fact]
        public void GradeCalc_InputScore95Attendance65_GetCGrade()
        {
            gradingCalculator.Score = 95;
        ...
        [InlineData(65, 55)]
        [InlineData(50, 90)]
        public void GradeCalc_FailureScenasrios_GetFGrade(int score, int attendance)
        {
        ...
        [InlineData(65, 55,  "F")]
        [InlineData(50, 90,  "F")]
        public void GradeCalc_AllGradeLogicalScenariosScenasrios_GetFGrade(int score, int attendance, string expected)
        {
            gradingCalculator.Score = score;
            gradingCalculator.AttendancePercentage = attendance;
